    ...
    public partial class AddAdminUser : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Status = c.String(),
                        TutoringRequestID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        SubjectRequestID = c.Int(nullable: false, identity: true),
                        subjectAreaName = c.String(),
                        subjectName = c.String(),
                    })
                .PrimaryKey(t => t.SubjectRequestID);
